...
public class DraftManager
{
    ...
    public DraftManager(HarvesterFactory harvesterFactory, ProviderFactory providerFactory)
        :this ()
    {
        this.HarvestersFactory = harvesterFactory;
        this.ProviderFactory = providerFactory;
    }

    public HarvesterFactory HarvestersFactory { get; private set; }
    ...
    public string RegisterHarvester(List<string> arguments)
    {
        ...
        try
        {
            IHarvester harvester = this.HarvestersFactory.GenerateHarvester(arguments);
