...
namespace NeedForSpeed
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            var consumption = vehicle.DefaultFuelConsumption;
            ...
            consumption = raceMotorcycle.DefaultFuelConsumption;
            Console.WriteLine(consumption);
            ...
            consumption = crossMotorcycle.DefaultFuelConsumption;
            Console.WriteLine(consumption);
            ...
            consumption = familyCar.DefaultFuelConsumption;
            Console.WriteLine(consumption);
            familyCar.Drive(100);
            ...
            consumption = sportCar.DefaultFuelConsumption;
            Console.WriteLine(consumption);
            sportCar.Drive(100);
            ...
            consumption = car.DefaultFuelConsumption;
            Console.WriteLine(consumption);
            car.Drive(100);
